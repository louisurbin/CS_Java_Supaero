...
public class Position implements Serializable {
    ...
    public static Position barycenter(Collection<Position> positions) {
        if (positions == null) {
            throw new IllegalArgumentException("Cannot compute barycenter of a null collection");
        }
        if (positions.isEmpty()) {
            throw new IllegalArgumentException("Cannot compute barycenter of an empty collection");
        }
        double x = 0;
        double y = 0;
